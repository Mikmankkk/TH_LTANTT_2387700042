# BÁO CÁO THỰC HÀNH BUOI1: CƠ SỞ LẬP TRÌNH BẢO MẬT
...
- **Kiểm thử trên Giao diện Web (`http://127.0.0.1:5000`)**:
  - `Email`: `manzvo428@gmail.com` $\rightarrow$ **Email hợp lệ** (Xanh)
...
---
*Hoàn thành trọn vẹn 3 bài thực hành trong BUOI1 theo đúng giáo trình.*
